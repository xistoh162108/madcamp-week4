...
final class WebRTCClient: NSObject, ObservableObject {
    ...
    private var signalingRoom: String = "controller"
    private var signalingUrl: String = "ws://192.168.0.12:8080"
    ...
    func startPeer() {
        ...
        config.iceServers = [RTCIceServer(
            urlStrings: [
                "stun:192.168.0.12:3478",
                "turn:192.168.0.12:3478?transport=udp",
                "turn:192.168.0.12:3478?transport=tcp"
            ],
            username: "imuuser",
            credential: "imupass"
        )]
